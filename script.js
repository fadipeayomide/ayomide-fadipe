...
const CONTACT_INFO = {
    ...
    website: 'https://ayomide-fadipe.vercel.app'
};
...
function shareAward(awardName) {
    const shareUrl = 'https://ayomide-fadipe.vercel.app/awards.html';
 ...
 */
function shareAward(awardName) {
    const shareUrl = 'https://ayomide-fadipe.vercel.app/#awards';
    const shareText = `🏆 I just earned: ${awardName} - Check out my portfolio!`;
